...
namespace HotelListing.API.CoreRepository
{
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        public async Task<TResult> AddAsync<TSource, TResult>(TSource source) // send over th Dto
        {
        ...
        public async Task<QueryParameters.PagedResult<TResult>> GetAllAsync<TResult>(QueryParameters queryParameters)
        {
            ...
            return new QueryParameters.PagedResult<TResult>
            {
                Items = items,
